...
public class NameGenerator {
    ...
    private final static InputStream boys = NameGenerator.class.getClassLoader().getResourceAsStream("BoyNames");
    private final static InputStream girls = NameGenerator.class.getClassLoader().getResourceAsStream("GirlNames");
    private final static InputStream last = NameGenerator.class.getClassLoader().getResourceAsStream("LastNames");
